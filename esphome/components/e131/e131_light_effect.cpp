...
E131LightEffect::E131LightEffect(const char *name) : LightEffect(name) {}

const StringRef E131LightEffect::get_name() { return LightEffect::get_name(); }
...
bool E131LightEffect::process(int universe, const E131Packet &packet) {
  ...
  ESP_LOGV(TAG, "Applying data for '%s' on %d universe, for %d-%d.", get_name(), universe, output_offset,
           output_end);
